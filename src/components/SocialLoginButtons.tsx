...
const SocialLoginButtons = ({ mode = "signin" }: SocialLoginButtonsProps) => {
  ...
  const handleSocialLogin = (provider: string) => {
    ...
    setTimeout(() => {
      ...
      toast({
        ...
        description: `${provider} ${mode === "signin" ? "sign in" : "sign up"} was initiated. This is a demo feature.`,
      });
    }, 1500);
    
    // In a real app, you would redirect to the provider's OAuth page or use a library like Firebase Auth
  };
  
  const actionVerb = mode === "signin" ? "Sign in" : "Sign up";
